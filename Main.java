...
public class Main {
    ...
    private static class Array {
        ...
        // homework
        public boolean deleteAll(int value) { // Сложность О(n)
        ...
        public boolean clear() { // Сложность О(1)
            size = 0;
            return true;
        }

        void insert(int index, int value) { // Сложность О(n)
        ...
        public int improvedSortBubble() { // Сложность О(n^2)
            int c = 0;
            boolean swap = false;
